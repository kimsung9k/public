...
class BoundingBox:
    ...
    def __init__(self, shapeOrTransform ):
        ...
        isEnable = sg.check.isTransformNode( self._target ) or sg.check.isShapeNode( self._target )
        ...
        self._parentMatrix = sg.convert.matrixFromList( cmds.getAttr( self._target + ".pm" ) )
...
class Mesh:
    ...
    def __init__(self, shape ):
        ...
        if type( shape ) == type( OpenMaya.MDagPath() ):
            ...
            if not sg.check.isMesh( shape ): return None
            self.dagPath = sg.base.getDagPath( shape )
        else: return None
    ...
    def duplicateAndAddFace( self, indicesPoly ):
        ...
        newFnMesh.create( addNumVertices, addNumPolys, addPoints, addVerticesCounts, addVerticesList, sg.base.getMObject( newMeshTransform ) )
        ...
        newMeshs = sg.get.nonIoMesh( newMeshTransform )
        ...
        cmds.parent( newMesh, sg.dag.getTransform( origMeshName ), add=1, shape=1 )
...
class Curve:
    ...
    def __init__(self, curveShape ):
        ...
        self.dagPath = sg.base.getDagPath( curveShape )
...
class Node:
    ...
    def __init__(self, nodeName ):
        ...
        self.oNode = sg.base.getMObject( nodeName )
...
class DagNode( Node ):
    ...
    def __init__(self, dagNodeName ):
        ...
        self.fnDagNode = OpenMaya.MFnDagNode( sg.base.getDagPath(dagNodeName) )
